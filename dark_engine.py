...
class DarkWorld:
    ...
    def _render_town(self):
        ...
        lines.append("")
        if c < 20:
            lines.append("工会 / 商店 / 酒馆 / 神殿 / 残壁 / 塔 / 出镇 [层名]")
    ...
    def _enter_boss_combat(self, lines):
        layer = self.area or "灰林"
    ...
    def _cmd_combat(self, inst):
        ...
        # 攻击/说话重置防御连击
        if inst in ("攻", "术") or inst.startswith("说"):
